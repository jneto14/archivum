...
<?php if($assist->hasPackage(\Laravel\Boost\Support\PackageRegistry::INERTIA_LARAVEL) || $assist->hasPackage(\Laravel\Boost\Support\PackageRegistry::INERTIA_REACT) || $assist->hasPackage(\Laravel\Boost\Support\PackageRegistry::INERTIA_VUE) || $assist->hasPackage(\Laravel\Boost\Support\PackageRegistry::INERTIA_SVELTE)): ?>
## Wayfinder + Inertia
...
<?php endif; ?>
<?php if($assist->hasPackage(\Laravel\Boost\Support\PackageRegistry::INERTIA_VUE)): ?>
___BOOST_SNIPPET_3___
<?php endif; ?>
<?php if($assist->hasPackage(\Laravel\Boost\Support\PackageRegistry::INERTIA_SVELTE)): ?>
...
<?php /**PATH /tmp/claude-1000/-home-neto-Projects-Archivum/68a100c7-112d-496c-b1b6-82b0f1ebfc76/scratchpad/archivum-scaffold/storage/framework/views/a8f2638daac871fd3d2a2c73e4de1313.blade.php ENDPATH**/ ?>