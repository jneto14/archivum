        ...
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
            <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        {t('settings.security.passkeys.item.added_prefix')}{' '}
                        ...
                        {passkey.last_used_at_diff && (
                            <>
                                ...
                                {t(
                                    'settings.security.passkeys.item.last_used_prefix',
                                )}{' '}
                                {passkey.last_used_at_diff}
                            </>
                        )}
            ...
            <Dialog>
                <DialogTrigger asChild>
                    ...
                    >
                        ...
                        <span className="sr-only">
                            {t(
                                'settings.security.passkeys.item.remove_sr_label',
                            )}
                        </span>
                    </Button>
                </DialogTrigger>
                <DialogContent>
                    <DialogTitle>
                        {t(
                            'settings.security.passkeys.item.remove_dialog_title',
                        )}
                    </DialogTitle>
                    <DialogDescription>
                        {t(
                    ...
                    <DialogFooter className="gap-2">
                        <DialogClose asChild>
                            <Button variant="secondary">
                                {t('settings.security.passkeys.item.cancel')}
                            </Button>
                        </DialogClose>
                        <Button
                            variant="destructive"
                        ...
                        >
                            {isDeleting
                                ? t('settings.security.passkeys.item.removing')
                                : t(
                                      'settings.security.passkeys.item.remove_button',
                                  )}
                        </Button>
                    </DialogFooter>
                </DialogContent>
