export default {
    ...
    'documents.index.filtered_by_location': 'Filed at',
    'documents.index.clear_location_filter': 'Show every location',
    'demo.banner':
    ...
    'documents.review.filter_all': 'All',
    'documents.review.filter_suggestions': 'Suggested',
    'documents.review.filter_readings': 'Readings',
    'documents.review.filter_duplicates': 'Duplicates',
    'documents.review.summary_suggestions': ':count suggested',
    'documents.review.summary_readings': ':count to read',
    'documents.review.summary_duplicates': ':count duplicate',
    'documents.review.select_document': 'Select :title',
    'documents.review.select_all': 'Select all on this page',
    'documents.review.selected_count': ':count selected',
    'documents.review.clear_selection': 'Clear',
    'documents.review.page_selected': 'All :count on this page are selected.',
    'documents.review.select_all_matching': 'Select all :count',
    'documents.review.all_matching_selected':
        'All :count documents matching this filter are selected.',
    'documents.review.select_page_only': 'Select this page only',
    'documents.review.bulk_accept_suggestions': 'Accept suggested values',
    'documents.review.bulk_dismiss_readings': 'Take readings off the queue',
    'documents.review.bulk_dismiss_duplicates': 'Keep both copies',
    'documents.review.confirm_accept_suggestions':
        'Write the suggested values onto every selected document? The values were read off the scans and nobody has checked them one by one.',
    'documents.review.confirm_dismiss_readings':
        'Take these readings off the queue? They are not marked as read by anybody — the text stays exactly as it is, and nothing is deleted.',
    'documents.review.confirm_dismiss_duplicates':
        'Clear the duplicate warnings on every selected document, keeping both copies? This cannot be undone.',
    ...
    'documents.show.attachment_actions': 'More actions',
    'documents.show.attachment_delete_button': 'Delete',
    'documents.show.replace_button': 'Replace file…',
    'documents.show.replace_with_phone_button': 'Replace with phone',
    'documents.show.versions_toggle_one': ':count earlier version',
    'documents.show.versions_toggle_other': ':count earlier versions',
    'documents.show.version_replaced_at': 'Replaced :date',
    'documents.show.version_uploaded_by': 'Uploaded :date by :name',
    'documents.show.version_uploaded': 'Uploaded :date',
    'documents.show.version_download': 'Download',
    'documents.show.version_restore': 'Restore',
    'documents.show.version_restore_confirm':
        'Put this file back? The one in its place now is kept in the history, not lost.',
    ...
    'organization.form.level_labels_label': 'Printable labels',
    ...
    'organization.labels.title': 'Location labels',
    'organization.labels.count_one': ':count label from :scheme',
    'organization.labels.count_other': ':count labels from :scheme',
    'organization.labels.print_button': 'Print',
    'organization.labels.empty': 'There is nothing here to label yet.',
    'organization.storage.print_label_tooltip': 'Print this label',
    'organization.storage.print_inside_tooltip':
        'Print the labels for everything inside',
    'organization.storage.print_level_labels': 'Labels: :level',
    ...
    'workspace.settings.token_expires_prefix': 'Expires',
    'workspace.settings.token_no_expiry': 'Never expires',
    'workspace.settings.token_expired': 'Expired',
    'workspace.settings.new_token_expiry_label': 'Expires after',
    'workspace.settings.token_lifetime_30': '30 days',
    'workspace.settings.token_lifetime_60': '60 days',
    'workspace.settings.token_lifetime_90': '90 days',
    'workspace.settings.token_lifetime_365': '1 year',
    'workspace.settings.token_lifetime_never': 'Never',
