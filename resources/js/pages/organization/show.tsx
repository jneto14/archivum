...
export default function OrganizationSchemeShow({
    ...
    // The rule dialog posts with `router` rather than a form helper, so the
    // errors come off the page. Without these the two rules the server enforces
    // here — a target level that cannot hold the rule, a matcher already in use
    // — refused the write and said nothing, from behind a dialog the page
    // banner cannot reach.
