    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                ...
                toggleText: t('auth.two_factor_challenge.recovery_toggle_text'),
            };
        }
        ...
        return {
            ...
            toggleText: t('auth.two_factor_challenge.code_toggle_text'),
        };
    }, [showRecoveryInput, t]);
                    ...
                    {({ errors, processing, clearErrors }) => (
                        <>
                            ...
                            <div className="text-center text-sm text-muted-foreground">
                                <span>
                                    {t(
                                        'auth.two_factor_challenge.toggle_prefix',
                                    )}
                                </span>
                                <button
                                    type="button"
